...
disp(raw_data(1:10)); // Muestra las primeras 5 líneas
...
N = [13, 8, 4]; // 13 entradas, 8 neuronas en la capa oculta, 4 salidas (one-hot)
...
// Convertir las salidas de la red a 0 o 1 (one-hot)
